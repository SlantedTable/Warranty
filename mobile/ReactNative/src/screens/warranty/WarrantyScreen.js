...
import { Button, Image, Text, Picker, View, TextInput, TouchableWithoutFeedback, Alert, KeyboardAvoidingView } from 'react-native';
      ...
      return (
        <View style={styles.loginScreenContainer}>
          ...
          <Text style={styles.logoText}>New Warranty</Text>
            <TextInput placeholder="Product Name" placeholderColor="#c4c3cb"  style={styles.warrantyFormTextInput} />
                <Button
            ...
            <TextInput placeholder="Product Number" placeholderColor="#c4c3cb"  style={styles.warrantyFormTextInput}/>
